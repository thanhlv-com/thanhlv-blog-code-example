...
public class Consumer {
        ...
        new Thread(() -> {
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, String> record : records) {
                    log.info("name: " + name + " , Group_id: " + props.get(ConsumerConfig.GROUP_ID_CONFIG) + " , Key: " + record.key() + ", Value: " + record.value() + ", Partition: " + record.partition() + ", Offset:" + record.offset());
                }
            }
        }).start();
    }
    ...
    public static Properties createPropertiesByGroupId(String groupId) {
        ...
        props.setProperty(ConsumerConfig.CLIENT_ID_CONFIG, "java-Consumer-producerRecordPartition");
